...
<head>
	<meta charset="UTF-8">
	<title>Tugas 2 | Freda Rizky Saputra</title>
...
<div class="col-md-8 col-md-offset-2">
	...
	<div class="page-header">
		<h2>Aplikasi Keluhan masyarakat</h2>
	</div>
	...
	<form ng-submit="submitComment()"> <!-- ng-submit will disable the default form action and use our function -->
		...
		<div class="form-group">
			<input type="text" class="form-control input-sm" name="author" ng-model="commentData.author" placeholder="Masukkan Nama Anda...">
		</div>

		<!-- COMMENT TEXT -->
		<div class="form-group">
			<input type="text" class="form-control input-lg" name="comment" ng-model="commentData.text" placeholder="masukkan Pesan anda.....">
		</div>
